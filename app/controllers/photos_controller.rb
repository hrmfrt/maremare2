class PhotosController < ApplicationController
  ...
  def create
    ...
    #params.photo.picture.each do |photo|
      #@photo = Photo.new(photo_params)
     # @photo["picture"] = "#{photo}"
      #@photo["photo"] = "#{params.caption}"     
      # @photo.photo = photo
      #@photo.save
    #end
  ...
  private
    ...
    def photo_params
      params.require(:photo).permit(:caption, :creature_id, :photo_by_id, :aquarium_id, :photo_set_id, :photo_num)
    end
