...
class CreaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creature" do
    assert_difference('Creature.count') do
      post creatures_url, params: { creature: { information: @creature.information, japanese_name: @creature.japanese_name, scientific_name: @creature.scientific_name } }
    end
  ...
  test "should update creature" do
    patch creature_url(@creature), params: { creature: { information: @creature.information, japanese_name: @creature.japanese_name, scientific_name: @creature.scientific_name } }
